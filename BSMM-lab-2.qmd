...
author: "pratik bhikadiya STUDENT-ID :105172589"
date: "25-09-2023"
format: html
editor: visual
self-contained: true
...
The artist with the most works in the Tate collection is **Turner, Joseph Mallord William** WITH ARTIST ID **558**

The artist with the tenth-most works in the Tate collection is **Warhol, Andy** WITH ARTIST ID **2121**
...
the_tate <- the_tate %>%
  mutate(area_cm2 = (width * height)/10000)
